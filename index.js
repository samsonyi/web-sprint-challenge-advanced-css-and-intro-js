...
function get20s(arr){
  ...
  for (i=0; i<arr.length; i++){
    let totalYears = arr[i].years;
    let birthdate = parseInt(totalYears.substring(0,5));
    if (birthdate >= 1900) {
